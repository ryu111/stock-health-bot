...
exports.FixedFormulaEngine = void 0;
const AnalysisEngine_1 = require("./AnalysisEngine");
const analysis_1 = require("../types/analysis");
const stock_1 = require("../types/stock");
// 固定公式引擎
class FixedFormulaEngine extends AnalysisEngine_1.BaseAnalysisEngine {
    constructor() {
        super();
        this.type = analysis_1.AnalysisType.TECHNICAL;
    ...
    async analyze(symbol, data) {
        try {
            ...
            // 根據市場類型進行分析
            if (data.marketType === stock_1.MarketType.ETF) {
                await this.analyzeETFData(data);
            }
            else {
                await this.analyzeStockData(data);
            }
...
exports.FixedFormulaEngine = FixedFormulaEngine;
// 註冊引擎
AnalysisEngine_1.AnalysisEngineFactory.registerEngine(analysis_1.AnalysisType.TECHNICAL, FixedFormulaEngine);
//# sourceMappingURL=FixedFormulaEngine.js.map