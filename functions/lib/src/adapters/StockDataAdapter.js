...
exports.StockDataAdapter = void 0;
const MarketDataAdapter_1 = require("./MarketDataAdapter");
const stock_1 = require("../types/stock");
// 股票數據適配器
class StockDataAdapter extends MarketDataAdapter_1.BaseMarketDataAdapter {
    constructor() {
        super(stock_1.MarketType.TW_STOCK);
    }
    /**
     * 取得股票數據
     * @param symbol - 股票代碼
    ...
    async fetchStockData(symbol) {
        try {
            ...
            console.error(`❌ 取得 ${symbol} 股票資料失敗，使用模擬資料:`, error instanceof Error ? error.message : 'Unknown error');
            // 返回模擬資料而不是拋出錯誤
    ...
    getMockData(symbol) {
        const mockData = {
            ...
            '2454.TW': {
                ...
                sector: '科技',
                industry: '半導體',
                longBusinessSummary: '聯發科技股份有限公司是全球領先的無線通訊及數位媒體晶片整合系統方案之主要供應商。',
...
exports.StockDataAdapter = StockDataAdapter;
//# sourceMappingURL=StockDataAdapter.js.map