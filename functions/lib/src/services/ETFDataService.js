...
class ETFDataService {
     ...
     * @returns 健康分數
     */
    calculateETFHealthScore(etfData) {
        let score = 50; // 基礎分數
        // 股息率分析 (40% 權重)
     ...
     * @returns 格式化的報告
     */
    formatETFReport(etfData, healthScore) {
...
${this.getETFRecommendation(healthScore, etfData)}`;
     ...
     * @returns 投資建議
     */
    getETFRecommendation(healthScore, _etfData) {
        if (healthScore >= 80) {
...
exports.ETFDataService = ETFDataService;
//# sourceMappingURL=ETFDataService.js.map