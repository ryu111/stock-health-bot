...
export class LocalizationService {
  ...
  private resources: LanguageResource;
  private defaultLanguage: SupportedLanguage = 'zh_TW';
  private currentLanguage: SupportedLanguage = 'zh_TW';
  ...
  // 初始化語言資源
  private initializeResources(): LanguageResource {
    return {
      // 通用訊息
      welcome: {
        zh_TW: '歡迎使用股健檢！',
  ...
  // 獲取貨幣格式化
  formatCurrency(value: number, currency: string = 'TWD', language?: SupportedLanguage): string {
    const targetLanguage = language || this.currentLanguage;
